This code presents implementation of algorithm which calculate n-th order derivative. There is used finite difference coefficients to calculate derivative from discrete data.
